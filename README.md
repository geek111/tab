...
Selected tabs can now be placed into groups. Click **Add to Group** in the bulk actions bar to create or join a tab group. This functionality uses the optional `tabGroups` permission and requires a Firefox version that supports tab grouping.
