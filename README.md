...
Starting with version 0.4 the extension introduces experimental tab groups. Tabs can be assigned to named groups via the tab context menu and groups are saved between sessions. You can add multiple selected tabs at once from the same menu. Groups can also be managed from the Options page.
