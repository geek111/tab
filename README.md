...
Starting with version 0.4 the extension introduces experimental tab groups. Tabs can be assigned to named groups via the tab context menu, and groups can be managed from the Options page. All groups are saved between sessions.
