...
Starting with version 0.4 the extension introduces experimental tab groups. Tabs can be assigned to named groups via the context menu or the popup dropdown and groups are saved between sessions. Groups can be created, renamed and deleted from the Options page.
