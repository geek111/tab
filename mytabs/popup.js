...
function refreshContainerDropdowns(identities) {
  ...
  if (target) {
    ...
    optDefault.textContent = 'No Container';
    ...
    if (containerMap.has(currentT) || currentT === 'firefox-default') {
      target.value = currentT;
    } else {
      target.value = identities[0]?.cookieStoreId || 'firefox-default';
    }
  }
}
