...
async function update() {
  ...
  try {
    ...
    const listForCounts = view === 'recent' ? tabs : allTabs;
    document.getElementById('total-count').textContent = listForCounts.length;
    const activeCount = listForCounts.filter(t => !t.discarded).length;
