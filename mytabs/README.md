...
- Tabs can be organized into named groups using the tab context menu.
- Groups can be created, renamed and deleted from the Options page. Version 0.4.2 introduces a dynamic "Add Tab(s) to Group" context menu listing your groups.
- A Groups view in the popup and full pages lists each group with actions to close, reload, unload or move all tabs from that group.
- Selected tabs can be added to any group directly from the popup context menu (Version 0.4.4).
