...
- A Groups view in the popup and full pages lists each group with actions to close, reload, unload or move all tabs from that group. Version 0.4.4 adds a dropdown in the bulk actions bar to assign selected tabs to a group.
