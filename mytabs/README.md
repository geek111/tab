...
- Bulk assign selected tabs to any Firefox container or move them back to the default container.
 - Tabs can be organized into custom groups managed on the Options page.
   Select tabs and use the context menu's **Assign to Group…** entry to place them in a group.
