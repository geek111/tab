...
- Tabs can be organized into custom groups accessible from the context menu and options page. Selected tabs can be added or removed using a bulk group drop-down.
