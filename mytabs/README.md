...
- A **Full View** window shows tabs in a responsive grid that fills the entire window.
  ...
  - Hovering a tab's icon in the popup or Full View shows a custom tooltip with the tab title and URL, truncated for brevity. In Full View, the tooltip also displays the tab's container when available.
