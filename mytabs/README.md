...
- Groups can be created, renamed and deleted from the Options page.
- Multiple selected tabs can be added or removed from a group via new context menu commands.
