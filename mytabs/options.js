...
const elKeyOpenPopup = document.getElementById('key-open-popup');
const elKeyOpenFull = document.getElementById('key-open-full');
const elKeyUnloadAll = document.getElementById('key-unload-all');
const elKeyViewAll = document.getElementById('key-view-all');
const elKeyViewRecent = document.getElementById('key-view-recent');
const elKeyViewDups = document.getElementById('key-view-dups');
...
elKeyOpenPopup.addEventListener('keydown', shortcutListener);
elKeyOpenFull.addEventListener('keydown', shortcutListener);
elKeyUnloadAll.addEventListener('keydown', shortcutListener);
elKeyViewAll.addEventListener('keydown', shortcutListener);
elKeyViewRecent.addEventListener('keydown', shortcutListener);
elKeyViewDups.addEventListener('keydown', shortcutListener);
